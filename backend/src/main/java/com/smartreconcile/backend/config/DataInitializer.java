...
public class DataInitializer implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                User admin = userRepository.findByEmail("admin@smartreconcile.com")
                                .orElseGet(() -> createUser("admin@smartreconcile.com", "admin123", "Admin User",
                                                ERole.ROLE_ADMIN));

                User finance = userRepository.findByEmail("finance@smartreconcile.com")
                                .orElseGet(() -> createUser("finance@smartreconcile.com", "finance123",
                                                "Finance Manager",
                                                ERole.ROLE_FINANCE_MANAGER));

                User accounts = userRepository.findByEmail("accounts@smartreconcile.com")
                                .orElseGet(() -> createUser("accounts@smartreconcile.com", "accounts123",
                                                "Accounts Executive",
                                                ERole.ROLE_ACCOUNTS));

                User vendorUser = userRepository.findByEmail("vendor@smartreconcile.com")
                                .orElseGet(
                                                () -> createUser("vendor@smartreconcile.com", "vendor123",
                                                                "Vendor User", ERole.ROLE_VENDOR));
